...
| `hunter_ros2` | [AgileX](https://github.com/agilexrobotics/hunter_ros2) | Hunter 系列底盘 ROS2 控制包 |
| `ugv_sdk` | [AgileX](https://github.com/agilexrobotics/ugv_sdk) | 通用 C++ 移动平台通信库，CAN 总线接口，支持 Scout/Hunter/Bunker 等 |
| `piper_ros` | [AgileX](https://github.com/agilexrobotics/piper_ros) | Piper 机械臂控制、描述、MoveIt 与仿真相关包 |
| `venom_px4_bridge` | [Venom-Algorithm](https://github.com/Venom-Algorithm/venom_px4_bridge) | PX4 集成项目根目录，内部包含 vendored `px4_msgs` 与 VNV 自有桥接包 |
...
| 目录 | 说明 |
|------|------|
| `simulation/venom_nav_simulation/` | 独立导航仿真工作区，用于 `MID360 + Gazebo + LIO + Nav2` 联调与回归测试 |
...
├── simulation/                      # 仿真相关子项目
│   └── venom_nav_simulation/        # MID360 + Gazebo + LIO + Nav2 仿真工作区
├── docs/                            # 项目文档
└── assets/                          # 文档图片资源
```
